...
<qgis version="2.9.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
 <edittypes>
  ...
  <edittype widgetv2type="ValueRelation" name="kind">
   <widgetv2config OrderByValue="1" AllowNull="1" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="code" Layer="vl_backflow_prevention_kind" Value="value_en" labelOnTop="0" AllowMulti="0"/>
  </edittype>
 ...
 <aliases>
  <alias field="dataowner" index="8" name=""/>
  <alias field="fk_wastewater_structure" index="10" name=""/>
  <alias field="gross_costs" index="1" name=""/>
  <alias field="identifier" index="4" name=""/>
  <alias field="kind" index="2" name=""/>
  <alias field="last_modification" index="7" name=""/>
  <alias field="obj_id" index="0" name=""/>
  <alias field="provider" index="9" name=""/>
  <alias field="remark" index="5" name=""/>
  <alias field="renovation_demand" index="6" name=""/>
  <alias field="year_of_replacement" index="3" name=""/>
 </aliases>
