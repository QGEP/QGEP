...
ALTER TABLE qgep.od_structure_part ADD COLUMN fs_wastewater_structure varchar (36);
...
ALTER TABLE qgep.od_wastewater_networkelement ADD COLUMN fs_wastewater_structure varchar (36);
...
WITH (
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN fs_owner varchar (36);
...
ALTER TABLE qgep.od_wastewater_structure ADD COLUMN fs_operator varchar (36);
...
WITH (
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_reach_point ADD COLUMN fs_wastewater_networkelement varchar (36);
...
WITH (
 ...
 ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE qgep.od_reach ADD COLUMN fs_reach_point_from varchar (36);
...
ALTER TABLE qgep.od_reach ADD COLUMN fs_reach_point_to varchar (36);
...
ALTER TABLE qgep.od_reach ADD COLUMN fs_pipe_profile varchar (36);
