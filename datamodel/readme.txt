...
6. generate_oid_function.sql - function for generating new OIDs
7. vw_network_node.sql - view for network following
8. vw_network_segment.sql - view for network following
