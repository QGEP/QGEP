...
COMMENT ON COLUMN qgep.od_wastewater_structure.identifier IS 'yyy_Pro Datenherr eindeutige Bezeichnung / Pro Datenherr eindeutige Bezeichnung / xxx_Pro Datenherr eindeutige Bezeichnung';
...
COMMENT ON COLUMN qgep.od_cover.location_accuracy IS 'yyy_Quantifizierung der Genauigkeit der Lage einer Koordinate. / Quantifizierung der Genauigkeit der Lage einer Koordinate. / Plage de précision des coordonnées planimétriques du couvercle.';
...
COMMENT ON COLUMN qgep.od_infiltration_installation.obj_id IS 'INTERLIS STANDARD OID (with Postfix/Präfix) or UUOID, see www.interlis.ch';
 ALTER TABLE qgep.od_infiltration_installation ADD COLUMN absorption_capacity  decimal(8,3) ;
