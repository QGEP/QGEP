...
ELSE 3016 --- unknown
END,
ST_Transform(ST_Force3D(ST_ForceCurve( ST_RemoveRepeatedPoints( ST_GeometryN( a_haltung.the_geom, 1 ) ) ) ), 2056), -- Convert single-part multilinestring to linestring by extracting the first (and only) part
-- verlauf, 
-- the_geom3D,  
