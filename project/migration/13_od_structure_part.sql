...
(obj_id, identifier, remark, renovation_demand, last_modification, dataowner, fk_wastewater_structure) 
...
ON a_bauwerksteil.abwasserbauwerk = q_wastewater_structure.old_obj_id;
